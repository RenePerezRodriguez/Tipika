...
namespace AppTipika.PersonDAL {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class UsuarioDataTable : global::System.Data.TypedTableBase<UsuarioRow> {
            ...
            private global::System.Data.DataColumn columnestadoPassword;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public global::System.Data.DataColumn estadoPasswordColumn {
                get {
                    return this.columnestadoPassword;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsuarioRow AddUsuarioRow(System.Guid idUsuario, string nombre, string password, string rol, bool eliminado, bool estadoPassword) {
            ...
            internal void InitVars() {
                ...
                this.columnestadoPassword = base.Columns["estadoPassword"];
            }
            ...
            private void InitClass() {
                ...
                this.columnestadoPassword = new global::System.Data.DataColumn("estadoPassword", typeof(bool), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnestadoPassword);
                ...
                this.columnestadoPassword.AllowDBNull = false;
            }
        ...
        public partial class UsuarioRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool estadoPassword {
                get {
                    return ((bool)(this[this.tableUsuario.estadoPasswordColumn]));
                }
                set {
                    this[this.tableUsuario.estadoPasswordColumn] = value;
                }
            }
        }
...
namespace AppTipika.PersonDAL.DataSetTableAdapters {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("estadoPassword", "estadoPassword");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Usuario] WHERE (([idUsuario] = @Original_idUsuario) AND ([nombre] = @Original_nombre) AND ([password] = @Original_password) AND ([rol] = @Original_rol) AND ([eliminado] = @Original_eliminado) AND ([estadoPassword] = @Original_estadoPassword))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_estadoPassword", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "estadoPassword", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Usuario] ([idUsuario], [nombre], [password], [rol], [eliminado], [estadoPassword]) VALUES (@idUsuario, @nombre, @password, @rol, @eliminado, @estadoPassword);
SELECT idUsuario, nombre, password, rol, eliminado, estadoPassword FROM Usuario WHERE (idUsuario = @idUsuario)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@estadoPassword", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "estadoPassword", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuario] SET [idUsuario] = @idUsuario, [nombre] = @nombre, [password] = @password, [rol] = @rol, [eliminado] = @eliminado, [estadoPassword] = @estadoPassword WHERE (([idUsuario] = @Original_idUsuario) AND ([nombre] = @Original_nombre) AND ([password] = @Original_password) AND ([rol] = @Original_rol) AND ([eliminado] = @Original_eliminado) AND ([estadoPassword] = @Original_estadoPassword));
SELECT idUsuario, nombre, password, rol, eliminado, estadoPassword FROM Usuario WHERE (idUsuario = @idUsuario)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@estadoPassword", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "estadoPassword", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_estadoPassword", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "estadoPassword", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=.;Initial Catalog=tipika;Integrated Security=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idUsuario, nombre, password, rol, eliminado, estadoPassword FROM dbo.Usuar" +
                "io";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "dbo.EstadoPassword";
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@password", global::System.Data.SqlDbType.VarChar, 10, global::System.Data.ParameterDirection.Input, 0, 0, null, global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Delete(System.Guid Original_idUsuario, string Original_nombre, string Original_password, string Original_rol, bool Original_eliminado, bool Original_estadoPassword) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((bool)(Original_estadoPassword));
        ...
        public virtual int Insert(System.Guid idUsuario, string nombre, string password, string rol, bool eliminado, bool estadoPassword) {
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((bool)(estadoPassword));
        ...
        public virtual int Update(System.Guid idUsuario, string nombre, string password, string rol, bool eliminado, bool estadoPassword, System.Guid Original_idUsuario, string Original_nombre, string Original_password, string Original_rol, bool Original_eliminado, bool Original_estadoPassword) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((bool)(estadoPassword));
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((bool)(Original_eliminado));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((bool)(Original_estadoPassword));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string password, string rol, bool eliminado, bool estadoPassword, System.Guid Original_idUsuario, string Original_nombre, string Original_password, string Original_rol, bool Original_eliminado, bool Original_estadoPassword) {
            return this.Update(Original_idUsuario, nombre, password, rol, eliminado, estadoPassword, Original_idUsuario, Original_nombre, Original_password, Original_rol, Original_eliminado, Original_estadoPassword);
        }
        
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual object EstadoPassword() {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual object ExisteUsuario(string nombre, string password) {
